...
interface IEmployeeDict {
  id?: Employee | Ceo;
}

export class Company {
  private employeeDict: IEmployeeDict;
  private ceo: Ceo;
  constructor() {
    this.employeeDict = {};
  }

  public addEmployee(id: string, name: string, managerId: string) {
  ...
  public addCeo(id: string, name: string) {
    if (this.ceo) {
  ...
  private traverseHierarchy(employeeDict: IEmployeeDict, eid: string, level = 0) {
